...
import type { WalletAccountId, EIP712MessageOptions, EIP712TypedData, KeyGenerationResult } from './types.js';

// Re-export types
export type { WalletAccountId, EIP712MessageOptions, EIP712TypedData, KeyGenerationResult } from './types.js';
...
export async function deriveKeysFromSignature(
  ...
  const prk = await crypto.subtle.importKey('raw', new Uint8Array(signatureHash), { name: 'HKDF' }, false, [
    'deriveBits',
  ]);
