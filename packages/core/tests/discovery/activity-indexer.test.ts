  ...
  describe("buildActivityIndex", () => {
    ...
    describe("1:1 withdrawal indexing", () => {
      it("should index same-chain withdrawals by nullifier", () => {
        ...
        expect(index.sameChainWithdrawalsByNullifier.get(withdrawal.spentNullifiers[0])).toBe(
          withdrawal
        );
      });
      ...
      it("should index cross-chain withdrawal intents by nullifier", () => {
        ...
        expect(index.crosschainWithdrawIntentsByNullifier.get(withdrawal.spentNullifiers[0])).toBe(
          withdrawal
        );
      });
    ...
    describe("Withdraw2 indexing", () => {
      it("should index Withdraw2 by both nullifiers", () => {
        ...
        expect(index.sameChainWithdraw2ByNullifier.get(withdraw2.spentNullifiers[0])).toBe(
          withdraw2
        );
        expect(index.sameChainWithdraw2ByNullifier.get(withdraw2.spentNullifiers[1])).toBe(
          withdraw2
        );
      });
      ...
      it("should index cross-chain Withdraw2 intents by both nullifiers", () => {
        ...
        expect(index.crosschainWithdraw2IntentsByNullifier.get(withdraw2.spentNullifiers[0])).toBe(
          withdraw2
        );
        expect(index.crosschainWithdraw2IntentsByNullifier.get(withdraw2.spentNullifiers[1])).toBe(
          withdraw2
        );
      });
    });
    ...
    describe("mixed activities", () => {
      ...
      it("should handle activities in any order", () => {
        ...
        expect(index1.sameChainWithdrawalsByNullifier.size).toBe(
          index2.sameChainWithdrawalsByNullifier.size
        );
      });
