...
interface RagequitTimelineScreenProps {
  amount: string;
  status: RagequitStatus;
  txHash: string | null;
  error: AppError | null;
  onClose: () => void;
}

export function RagequitTimelineScreen({
  amount,
  status,
  txHash,
  error,
  onClose,
}: RagequitTimelineScreenProps) {
  ...
  const timeline: TimelineItem[] = [
    {
      ...
      description: "Generating commitment proof.",
