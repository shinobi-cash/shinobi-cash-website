...
:::note[Audience]
This page is for **Users, Developers, and Regulators** seeking to understand how Shinobi Cash balances privacy with compliance.
:::

:::info[TL;DR]
Association Set Providers (ASPs) review deposits and approve compliant ones. Withdrawals prove ASP membership **without revealing which deposit**. Privacy is preserved; compliance is verifiable.
:::
